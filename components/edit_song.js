...
export default function UpdateSong() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const response = await fetch('http://172.21.48.189/YY_Music_JS/backend/index.php?action=updateSong', {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
                body: JSON.stringify({ id, 'username': song_username, 'song_artist': song_artist, song_name, song_rating })
            });
